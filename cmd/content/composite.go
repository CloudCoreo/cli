...
`
	...
	DefaultFilesTableYAMLContent = `# Use this file to customise the output of the html report you will receive for this audit.
# Supply a rule name followed by any information you wish to receive in the given format:

# rule-name-1:
#  "AWS Object ID": "__OBJECT__~https://console.aws.amazon.com/ec2/v2/home?region=+__OBJECT__.violations.__RULE__.region+#SecurityGroups:search=+__OBJECT__+;sort=desc:tag:Name"
...
`
	...
	DefaultFileSuppressionYAMLContent = `# Use this file to suppress any object should you not wish to receive an alert about it.
# Any suppressed object will not trigger a violation until the specified date.

# put-rule-name-1:
#   - put-your-object-id-here-1: ""
#   - put-your-object-id-here-2: "2017-01-10T00:00Z"
# put-rule-name-1:
#   - put-your-object-id-here-1: ""
#   - put-your-object-id-here-2: "2017-01-10T00:00Z"


# Suppression times (optional) use ISO date formats according to this template:
#
...
`
	...
	Scripts contained in this directory will be processed (if possible) when an instance "is asked to shut down.
...
##   - delete_backups.sh`
	...
	Scripts contained in this directory will be processed when an instance is booting.
	The order in which these scripts will be run is defined by the order.yaml`
