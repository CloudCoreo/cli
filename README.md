...
Download `coreo` from [https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_darwin_amd64](https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_darwin_amd64)

```sh
$ mkdir coreo && cd coreo
$ wget -q -O coreo https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_darwin_amd64
$ chmod +x coreo
...
Download `coreo` from [https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_linux_amd64](https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_linux_amd64)

```sh
$ mkdir coreo && cd coreo
$ wget -q -O coreo https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_linux_amd64
$ chmod +x coreo
$ export PATH=$PATH:${PWD}   # Add current dir where coreo has been downloaded to
$ coreo
```
...
Download `coreo.exe` from [https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_windows_amd64.exe](https://github.com/CloudCoreo/cli/releases/download/v0.0.12/coreo_windows_amd64.exe)
