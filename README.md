...
Download `vss` from [https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_darwin_amd64](https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_darwin_amd64)

```sh
 mkdir vss && cd vss
 wget -q -O vss https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_darwin_amd64
 chmod +x vss
...
Download `vss` from [https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_linux_amd64](https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_linux_amd64)

```sh
 mkdir vss && cd vss
 wget -q -O vss https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_linux_amd64
 chmod +x vss
 export PATH=$PATH:${PWD}   # Add current dir where vss has been downloaded to
 vss
```
...
Download `vss.exe` from [https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_windows_amd64.exe](https://github.com/CloudCoreo/cli/releases/download/v0.0.29/vss_windows_amd64.exe)
